<div class="row p-t-10">
    <div class="col-md-6 card card-body bg-secondary text-white">
        ...
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">CNPJ</label>
            <div class="col-md-9">
        ...
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Nome Entidade</label>
            <div class="col-md-9">
        ...
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Nome Fantasia</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="{{$emissora->entidade['entidade_nome_fantasia']}}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">DDD</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Telefone</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Email para Contato</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Tipo Usuário</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Tipo Orgão</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
    ...
    <div class="col-md-6 card card-body bg-secondary text-white">
        ...
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">CPF</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Nome Responsável</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">E-mail</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
    ...
    <div class="col-md-6 card card-body bg-light">
        ...
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Serviço</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="{{$emissora->servico}}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Carater</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="{{$emissora->carater}}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Fistel</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="{{$emissora->fistel}}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Pasta Cadastral</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="{{$emissora->entidade['habilitacao_numscradjur']}}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">SCRAD Técnico</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="{{$emissora->entidade['habilitacao_numscradtec']}}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Validade da Radiofrequência</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="{{$emissora->entidade['habilitacao_datavalfreq']}}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Finalidade</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="{{$emissora->entidade['finalidade']}}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Abrangência</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
    ...
    <div class="col-md-6 card card-body bg-light">
        ...
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Número Processo</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Número Documento</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Tipo Documento</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Orgão</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Data do Documento</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Data (DOU)</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Razão do Documento</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Natureza</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
    ...
    <div class="col-md-12 card card-body bg-secondary text-white">
        <h4>Informações do documento da Outorga</h4>
        @php
            $documentAutorga = isset($emissora->documento_historico) ? $emissora->documento_historico : [];
        @endphp
        <table class="table text-white">
            ...
            <tbody>
                @foreach($documentAutorga as $value)
                    @if($value['razao'] && $value['razao'] == 'Outorga')
                        <tr>
    ...
    <div class="col-md-6 card card-body bg-light">
        ...
        @endphp
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">CEP</label>
            <div class="col-md-9">
        ...
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Logradouro</label>
            <div class="col-md-9">
        ...
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Número</label>
            <div class="col-md-9">
        ...
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Complemento</label>
            <div class="col-md-9">
                <input class="form-control" type="text" value="---" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="example-search-input" class="col-md-3 col-form-label text-right">Bairro</label>
            <div class="col-md-9">
